...
public class RPSLSpock {
    ...
    /**
     * @Garrison This is to check to see if the user inputed a valued statement
     * if not. It will return false and cause a repeat in the loop of the main class
     */
    ...
    /**
     * @Garrison Computer decides what move it wants to make.
     * It is completely random so player input has no impact on computer decision
     */
    ...
    /**
     * @Garrison This method is to figure out if the computer won. If so, it returns true.
     * if none of these are true, then it returns false and player wins
     */
